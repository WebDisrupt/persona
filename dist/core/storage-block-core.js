...
exports.BaseStorageBlock = void 0;
...
var fs = require("fs");
var BaseStorageBlock = /** @class */ (function (_super) {
    __extends(BaseStorageBlock, _super);
    /**
     * Constructor - Used to assign personaOptions.
     * @param options
     */
    function BaseStorageBlock(options) {
     ...
     * @returns
     */
    BaseStorageBlock.prototype.load = function (storageBlockId) {
   ...
   * @returns
   */
    BaseStorageBlock.prototype.save = function (storageBlockId, content) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    BaseStorageBlock.prototype.create = function (filename, content) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @param content - contains a string of important data that is saved
     */
    BaseStorageBlock.prototype.update = function (filename, content) {
        return __awaiter(this, void 0, void 0, function () {
            var err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    BaseStorageBlock.prototype["delete"] = function (storageBlockId) {
    ...
    return BaseStorageBlock;
}(module_1.BaseModule));
exports.BaseStorageBlock = BaseStorageBlock;
//# sourceMappingURL=storage-block-core.js.map